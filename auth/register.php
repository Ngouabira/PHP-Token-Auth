                ...
                <div class="authentication-inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="mb-4">Faites de la gestion de votre application facile et amusante!</p>
                            <?php if (isset($errors)): ?>
                            ...
                            <form id="formAuthentication" class="mb-3" action="/register" method="POST">
                                ...
                                <button class="btn btn-primary d-grid w-100" type="submit" name="register">Créer un compte</button>
                            </form>
